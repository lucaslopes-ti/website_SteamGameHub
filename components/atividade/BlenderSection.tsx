  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-steam-darker border border-steam-blue rounded-lg p-6">
        ...
        <div className="bg-steam-blue/10 border border-steam-blueLight rounded-lg p-4 mb-4">
        ...
        <div className="space-y-4 text-gray-300">
          ...
          <div className="flex gap-4">
            <span className="font-bold text-steam-blueLight">5.</span>
            <div className="flex-1">
          ...
          <div className="flex gap-4">
            <span className="font-bold text-steam-blueLight">6.</span>
            <div className="flex-1">
        ...
        <div className="mt-6 bg-steam-green/10 border border-steam-green rounded-lg p-4">
          <div className="flex items-start gap-3">
            <span className="text-steam-green font-bold text-lg">💡</span>
            <div>
              <p className="text-steam-green font-semibold mb-2">Ligação com a Prática C#:</p>
              <p className="text-gray-300 text-sm mb-2">
      ...
      <div className="bg-steam-darker border border-steam-blue rounded-lg p-6">
        ...
        <div className="mb-3 bg-steam-blue/10 border border-steam-blue rounded-lg p-3">
          <p className="text-sm text-gray-300 mb-2">
            <strong className="text-steam-blueLight">Dica:</strong> Descreva os objetos que você modelou e como eles se relacionam com o código C# que você desenvolveu:
          </p>
