      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {topRated.map((game) => (
          <div key={game.id} className="relative">
            <div className="absolute top-2 left-2 z-10 flex items-center gap-1 bg-senai-blueDark/90 backdrop-blur-sm px-2 py-1 rounded-full border border-yellow-400/30">
