    ...
    <div className="container mx-auto px-4 py-8">
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-4xl font-bold text-steam-blueLight">Meus Favoritos</h1>
        </div>
      </div>
      ...
      {loading ? (
        ...
        <div className="bg-steam-dark rounded-lg p-12 text-center">
          ...
          <p className="text-gray-500 mb-6">
            Explore os jogos e adicione aos favoritos clicando no ícone de coração
          </p>
          <Link
            href="/games"
        ...
        <>
          <p className="text-gray-400 mb-6">
            {favoriteGames.length} jogo{favoriteGames.length !== 1 ? "s" : ""} favoritado{favoriteGames.length !== 1 ? "s" : ""}
          </p>
